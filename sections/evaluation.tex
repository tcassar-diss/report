...
\todo{reduce failure problem; talk about setuid}

This is an implementation detail artefact, and not a problem with the core
filtering solution. A \texttt{setuid} program would be able 
