...
applications. There is no direct access to hardware, \ac{io} devices, or the 
...
call to \texttt{mmap()} from the \acfg{os} C standard library (e.g. \texttt{libc}).
...
\acp{lsm} has been added as part of a suite of security tools for \ac{bpf}
