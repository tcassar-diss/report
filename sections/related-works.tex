...
As referenced in Section~\ref{subsec:assumptions}, \af presupposes that some
...
\ac{isa}\footnote{This, unfortunately, means that it is incompatible with \af as \af
currently only supports x86.}, and can stop an attacker from moving through the
\ac{vma} at will. 
