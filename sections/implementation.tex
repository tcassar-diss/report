...
\todo{A limitations section (maybe)}
...
\todo{how to justify the \texttt{syso} design decisions? they are silly because
    I did them first when I was unwise!}
