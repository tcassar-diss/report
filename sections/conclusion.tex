...
% To investigate the variability in performance, we altered \af to record
% timestamps during its execution. We found that system calls issued during the
% Redis benchmark were significantly faster to process than other system calls
